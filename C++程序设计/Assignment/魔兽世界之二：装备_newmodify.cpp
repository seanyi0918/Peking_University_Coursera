...
private:
    ...
    double morale;
public:
    Dragon(Headquarter * p, int no_, int kindNo_, int weapon_num, double morale_): Warrior(p, no_, kindNo_), weapon(weapon_num), morale(morale_) {}
    virtual void PrintResult(int nTime);
};
...
private:
    ...
    int weapon2;
public:
    Ninjia(Headquarter * p, int no_, int kindNo_, int weapon_num_1, int weapon_num_2): Warrior(p, no_, kindNo_), weapon1(weapon_num_1), weapon2(weapon_num_2) {}
    virtual void PrintResult(int nTime);
};
...
private:
    int weapon;
public:
    Iceman(Headquarter * p, int no_, int kindNo_, int weapon_num): Warrior(p, no_, kindNo_), weapon(weapon_num) {}
    virtual void PrintResult(int nTime);
};
...
void Dragon::PrintResult(int nTime)
{
    ...
    cout << "It has a " <<  weapon_list[weapon] << ",";
...
{
    Warrior::PrintResult(nTime);
    cout << "It has a " << weapon_list[weapon1] << " and a " << weapon_list[weapon2] << endl;
}

void Iceman::PrintResult(int nTime)
{
    Warrior::PrintResult(nTime);
    cout << "It has a " << weapon_list[weapon] << endl;
}
...
int Headquarter::Produce(int nTime)
{
    ...
    if ( kindNo == 0 )
        pWarriors[totalWarriorNum] = new Dragon( this, totalWarriorNum+1, kindNo, (totalWarriorNum+1) % 3, (double)totalLifeValue / Warrior::initialLifeValue[kindNo]);
    else if ( kindNo == 1 )
        pWarriors[totalWarriorNum] = new Ninjia( this, totalWarriorNum+1, kindNo, (totalWarriorNum+1) % 3, (totalWarriorNum+2) % 3);
    else if ( kindNo == 2 )
        pWarriors[totalWarriorNum] = new Iceman( this, totalWarriorNum+1, kindNo, (totalWarriorNum+1) % 3);
    else if ( kindNo == 3 )
