...
private:
	...
	int loyalty;
public:
	static char * weapons[WEAPON_NUM];
...
char * Warrior::weapons[WEAPON_NUM] = { (char *)"sword", (char *)"bomb", (char *)"arrow" };
